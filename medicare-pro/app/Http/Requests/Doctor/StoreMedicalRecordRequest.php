...
class StoreMedicalRecordRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'symptoms' => ['required', 'string', 'min:2', 'max:2000'],
     ...
     *
     * Ensures the patient belongs to the same hospital as the doctor
     * and validates vital sign logical consistency.
     */
    ...
    public function messages(): array
    {
        return [
            ...
            'symptoms.required' => __('validation.required', ['attribute' => __('validation.attributes.symptoms')]),
